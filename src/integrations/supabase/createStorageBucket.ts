...
const uploadLogo = async () => {
  try {
    ...
    const logoUrl = "/eyefemm-uploads/a3d06283-3588-47bd-b72e-8fe5ff5799e2.png";
    const logoResponse = await fetch(logoUrl);
    
    if (!logoResponse.ok) {
      // Try the fallback URL
      const fallbackLogoResponse = await fetch('/eyefemm-uploads/e2b16d7e-6663-42fc-bd9b-68fed360f249.png');
